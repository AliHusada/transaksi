					...
					<div class="box box-info '">
						<div class="box-body">
							...
							<table style="margin-top: 2%;" class="table">
								<tr>
									<th class="bg-gray" colspan="4" >Data Penjualan</th>
								...
								<tr>
									...
									<th class="bg-default" width="225" >Pelanggan :</th>
									<th class="bg-default"  >
								...
								<tr>
									...
									<th class="bg-default" width="300" >
										<div class="form-inline" >
											...
											<a href="pencarian_barang?menu=penjualan" class="btn btn-info "><i class="fa fa-search"></i></a>
	...
	function bayar(){
		...
		$('#simpan').click(function(){
			...
			$.ajax({
				...
				data:{bayar:bayar,kembali:kembali,nop:nop,plg:plg,tgl:tgl,total:i,jumlah:jml,ket:ket},
				type:'POST',
				success:function(){
